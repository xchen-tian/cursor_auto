...
```powershell
cursor --remote-debugging-port=9222 C:\p\your-project
```
...
# 终端 1 —— 控制 project-a
cd c:\p\cursor_auto
node src/auto_click.js --port 9222 --verbose --force --scan-tabs
...
# 浏览器打开 http://localhost:5123，Port 输入框填 9222
